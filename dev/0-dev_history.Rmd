---
title: "R Package of Handy Personal Functions and Simple Data References"
...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Personal R Package of Handy Functions and Simple Data References",
    Description = "This Package is intended to store some simple, personalized
    R functions and a few small data sets that can be loaded into any project.",
    `Authors@R` = c(
      person("Jason", "Locklin", email = "Jason_Locklin@wrdsb.ca", role = c("aut", "cre"), comment = c(ORCID = "0000-0001-7777-9065"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Jason Locklin")
```
...
fusen::init_share_on_github(ask = FALSE)
```
